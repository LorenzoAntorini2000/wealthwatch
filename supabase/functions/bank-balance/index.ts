...
Deno.serve(async (req) => {
  ...
  const appId = await getUserSecret(adminClient, userId, "enable_banking_app_id");
  const privateKeyPem = await getUserSecret(adminClient, userId, "enable_banking_private_key");
